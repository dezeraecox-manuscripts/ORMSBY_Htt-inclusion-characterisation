...
channel_1_name = "c:5/8 - "+impname
#print channel_1_name
channel_2_name = "c:4/8 - "+impname
#print channel_2_name
channel_3_name = "c:8/8 - "+impname
...
IJ.run("Add Image...", "image=[channel_1] x=0 y=0 opacity=70")
IJ.run("Add Image...", "image=[channel_2] x=0 y=0 opacity=40")
